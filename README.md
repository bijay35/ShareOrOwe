...
4. Check **Home** tab anytime to see the net balance summary
   - both the Split and Owe pages now include collapsible filter controls at the top.  Tap "Filter" to
     expand/collapse the section. Use the person dropdown plus a status selector (All/Settled/Unsettled)
     and optional From/To dates to narrow results.
